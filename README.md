...
- 当前课程：听力 `W01D01–W01D35`，口语 `S01D01–S01D35`；`01–05` 保留为 3B 听说基线与旧坑复习周，`06–10` 为 4A M1U1/M1U2，`11–15` 为 M1U3，`16–20` 为 M2U1。口语 S16 因已有 formal 记录保持原样，S17–S20 已按教材第17–21页优化。`21–25` 严格同页对齐 4A M2U2 第22–26页，`26–30` 严格同页对齐 M2U3 第27–31页，`31–35` 严格同页对齐 M3U1 第32–36页；本批不进入 M3U2。
...
`tools/` 开发期课程与音频生成（`build_courses_31_35.py` 可重建本批 M3U1 JSON 和家长文档）。
