...
class StreamlitPublicationGateTests(unittest.TestCase):
    def test_listening_renumbered_courses_are_exposed_by_streamlit(self):
        ...
        self.assertIn("L4A-T1-W01-D25", progress.all_courses())
        ...
        self.assertIn("L4A-T1-W01-D25", courses)
    ...
    def test_speaking_renumbered_courses_are_exposed_by_streamlit(self):
        ...
        self.assertIn("S4A-T1-W01-D25", speaking_models.all_courses())
        ...
        self.assertIn("S4A-T1-W01-D25", courses)
