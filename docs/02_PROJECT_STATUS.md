...
> 最后更新：2026-08-29
> 当前阶段：P5 上线切换与验收完整通过；P6 第一周课程设计已确认，尚未开始内容制作或生产发布
...
P5 已完整验收通过。00 已确认 P6 第一周课程编号、范围、题量、难度和时长。下一步由 01 开发内容，02 先完成新编号兼容再负责测试与部署；正式开放仍需家长确认学校实际已教页段。线上 formal 由 00 直接分析；学校练习/考试交给 03 批改入库。
